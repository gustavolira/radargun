...
public class RESTHttp2CacheService extends AbstractRESTHttp2Service {
   private static final Log log = LogFactory.getLog(RESTHttp2CacheService.class);
   ...
   @ProvidesTrait
   public RESTHttp2CacheInfo createCacheInfo() {
      return new RESTHttp2CacheInfo(this);
   }

   @ProvidesTrait
   public RESTHttp2CacheOperations createOperations() {
      return new RESTHttp2CacheOperations(this);
   }
